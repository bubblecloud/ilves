...
public final class CompanyFlowViewlet extends AbstractFlowViewlet {
    ...
    protected void addFlowlets() {
        final Flowlet companysView = new CompaniesFlowlet();
        addFlowlet(companysView);
        final Flowlet companyView = new CompanyFlowlet();
        addFlowlet(companyView);
        setRootFlowlet(companysView);
    }
