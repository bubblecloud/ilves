...
public final class UserDirectoryFlowViewlet extends AbstractFlowViewlet {
    ...
    protected void addFlowlets() {
        final Flowlet userDirectoriesView = new UserDirectoriesFlowlet();
        addFlowlet(userDirectoriesView);
        final Flowlet userDirectoryView = new UserDirectoryFlowlet();
        addFlowlet(userDirectoryView);
        setRootFlowlet(userDirectoriesView);
    }
