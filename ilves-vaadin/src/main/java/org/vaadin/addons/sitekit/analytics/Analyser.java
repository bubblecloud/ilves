package org.vaadin.addons.sitekit.analytics;
...
public class Analyser extends AbstractJavaScriptExtension implements ViewChangeListener {
    private String gaTrackingId;

    public Analyser(UI ui, String gaTrackingId) {
