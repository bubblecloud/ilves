...
public final class CurrencyFormatter extends PropertyFormatter {
     ...
     */
    public CurrencyFormatter(final Property propertyDataSource) {
    ...
    public Object parse(final String formattedValue) throws Exception {
        if (formattedValue == null || formattedValue.length() == 0) {
            ...
            initialize();
            final Number number = format.parse(formattedValue);
